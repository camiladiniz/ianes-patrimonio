...
public class PatrimonioController {
	...
	public String salvar(@Valid Patrimonio patrimonio, BindingResult brPatrimonio, @RequestParam(name = "categoria.id", required = false) String categoria, @RequestParam(name="novaCategoria", required = false) String novaCategoria, Model model, HttpSession session, @RequestPart(name = "imagem", required = false) MultipartFile imagem) {
		...
		System.out.println("Nova categoria: " +ehNovaCategoria);
		System.out.println("Qnt erros: " +brPatrimonio.getFieldErrors().size());
		System.out.println(patrimonio.getCategoria().toString());
